...
for subdir in [SATELLITE_DIR, LIDAR_DIR, PROCESSED_DIR, EXPORTS_DIR, REPORTS_DIR, MAPS_DIR]:
...
__all__ = [
    'TARGET_ZONES', 'APIConfig', 'DetectionConfig', 'ScoringConfig',
    'VisualizationConfig', 'ProcessingConfig', 'QualityConfig',
